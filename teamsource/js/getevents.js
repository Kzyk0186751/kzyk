$.ajax({
  ...
  success: function(response){
	...
	for(var i = 0;i<arr.length;i++){
		...
		html += '<img class="card-img-top" src="../boostraped/teamsource/img/'+arr[i]['eventImage']+'" alt="Card image cap">';
		html += '<div class = "card-body bg-primary" style = "padding:15px;">';
		html += '<div class="post-preview">';
        html += '<h2><a href = "event.html?id='+arr[i]['eventId']+'">'+arr[i]['eventName']+'</a></h2>';
